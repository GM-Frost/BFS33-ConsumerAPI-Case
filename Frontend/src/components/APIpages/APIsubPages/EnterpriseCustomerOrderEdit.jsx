...
const EnterpriseCustomerOrderEdit = () => {
  ...
  const handleEditOrder = async (e) => {
    ...
    try {
      const editOrderItem = await axios.put(
        `http://localhost:9005/api/enterprise/customers/${customerID}/orders/${orderID}`,
        orderItem,
        {
  ...
  useEffect(() => {
    fetch(`http://localhost:9005/api/enterprise/orders/${orderID}`)
...
export default EnterpriseCustomerOrderEdit;
